...
const contact = (props: Props) => {
  return (
    <div
      ...
      className="border-myspace-blue border-2 w-5/6 h-1/5 relative min-h-[150px] max-h-[180px]"
    >
      ...
      <div className="flex relative font-Pixel w-full h-full max-h-[85%]  top-0 left-0 ">
        {/* ////////////////////////////LEFT SPAN //////////////////////////////////////////// */}
        <div className="flex flex-col justify-around w-1/2 absolute h-full">
        ...
        {/* ////////////////////////////// RIGHT SPAN ////////////////////////////////////////// */}
        <div className=" flex flex-col w-1/2 absolute left-1/2 justify-center">
          <div className="flex ml-4 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="15"
